...
public class Connection implements ConnectionBase {
	 ...
	 * @param object The object to send. If the object is a JsonElement, its string representation is sent. Otherwise, the object is serialized to Json.
	 * @return A Future for the operation
	 */
	 ...
	 * @throws Exception An exception could be thrown if there an error while processing the message
	 */
