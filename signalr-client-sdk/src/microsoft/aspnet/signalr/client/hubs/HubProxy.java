...
public class HubProxy {
	...
	private static final List<String> EXCLUDED_METHODS = Arrays.asList(new String[] {"equals", "getClass", "hashCode", "notify", "notifyAll", "toString", "wait"});
						...
						try {
							...
							if (result.getResult() != null && resultClass != null) {
								...
								resultObject = 
										mConnection
										.getGson()
										.fromJson(result.getResult(), resultClass);
							}
						} catch (Exception e) {
							errorHappened = true;
	...
	public <E1, E2, E3, E4, E5> void on(
			String eventName, 
			final SubscriptionHandler5<E1, E2, E3, E4, E5> handler,
			Class<E1> parameter1,
			Class<E2> parameter2,
			Class<E3> parameter3,
			Class<E4> parameter4,
	...
	public <E1, E2, E3, E4> void on(
			String eventName, 
			final SubscriptionHandler4<E1, E2, E3, E4> handler,
			Class<E1> parameter1,
			Class<E2> parameter2,
			Class<E3> parameter3,
			Class<E4> parameter4) {
	...
	public <E1, E2, E3> void on(
			String eventName, 
			final SubscriptionHandler3<E1, E2, E3> handler,
			Class<E1> parameter1,
			Class<E2> parameter2,
			Class<E3> parameter3) {
	...
	public <E1, E2> void on(
			String eventName, 
			final SubscriptionHandler2<E1, E2> handler,
			Class<E1> parameter1,
			Class<E2> parameter2) {
	...
	public <E1> void on(
			String eventName, 
			final SubscriptionHandler1<E1> handler,
			Class<E1> parameter1) {
